...
public class TroveVideoModel implements Parcelable {
    private String svTitle;
    private String svDescription;
    private String svThumbnailURL;
    private String svVideoID;

    public TroveVideoModel () { //for adding VideoModels elements to ArrayList
        super();
    }
    ...
    protected TroveVideoModel(Parcel in) {
    ...
    public static final Parcelable.Creator<TroveVideoModel> CREATOR = new Parcelable.Creator<TroveVideoModel>() {
        @Override
        public TroveVideoModel createFromParcel(Parcel in) {
            return new TroveVideoModel(in);
        }

        @Override
        public TroveVideoModel[] newArray(int size) {
            return new TroveVideoModel[size];
        }
    };
}